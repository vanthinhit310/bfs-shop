                    ...
                    <a-col :xs="{ span: 24 }" :lg="{ span: 24 }">
                        <a-space :size="10">
                            <transition name="fade" mode="out-in">
                                <a v-if="settings.ecommerce_store_phone" :href="`tel:${settings.ecommerce_store_phone}`">
                                    <a-icon type="phone" />
                                    {{ settings.ecommerce_store_phone }}
                                </a>
                            </transition>
                            <transition name="fade" mode="out-in">
                                <a v-if="settings.theme_shop_map" target="_blank" :href="settings.theme_shop_map">
            ...
            <div class="container">
                <div class="bottom-header-content">
                    <a-row type="flex" justify="space-between" align="middle">
                        <a-col :span="0" :offset="0" :lg="{ span: 5 }">
                            <div class="main-logo">
                                <transition name="fade" mode="out-in">
                        ...
                        <a-col :offset="0" :span="21" :lg="{ span: 16, offset: 1 }">
